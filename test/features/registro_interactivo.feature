...
Característica: Registro interactivo
  ...
  Escenario: Registrar un episodio
    Dado que el paciente tiene un médico asignado (invitacion valida),
    Cuando accede al formulario de registro de episodios de migraña
